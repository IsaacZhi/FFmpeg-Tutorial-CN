...
旧版备注：\marginpar{\rule[-15mm]{0.4mm}{15mm}}{\textbf{备注：}\small 为什么使用avcodec_decode_audio2()？因为曾经有一个avcodec_decode_audio()，但现在被废弃了。这个新的函数通过data_size变量来算出从audio_buf读取多少数据。}
